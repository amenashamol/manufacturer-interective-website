        ...
        <div className="hero min-h-screen">
            <div className="hero-content flex-col lg:flex-row-reverse">
                ...
                <div >
                    ...
                    <p  data-aos='fade-right' data-aos-delay='400' data-aos-duration='900' className="py-6">A hammer drill is a convenient device to have in your toolbox, as you can use it for several different applications. These tools are handy and help in carrying out relatively light-duty jobs. They are competent to drill holes in concrete, brick, wood, stone, and other hard materials. You can effortlessly drill holes into your house’s masonry for various requirements, such as hanging a photo frame, installing a floating shelf, and more.</p>
